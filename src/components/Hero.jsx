            ...
            >
                {slides.map((slide, index) => (
                    <SwiperSlide key={index}>
                        ...
                        />
                        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-center gap-32 px-4">
                            <h1 className="text-white font-serif text-8xl leading-tight">
